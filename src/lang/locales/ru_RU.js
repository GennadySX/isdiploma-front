...
module.exports = {
  ...
  "user.email": "E-mail",
  "user.emailOrLogin": "E-mail или логин",
  "user.login": "Логин",
  ...
  "menu.chat_page": "Чат",
  "menu.data-list": "Data список",
  "menu.thumb-list": "Тхаб List",
  "menu.image-list": "Гелерея",
  "menu.details": "Детали",
  "menu.search": "Поиск",
  "menu.login": "Авторизация",
  "menu.register": "Регистрация",
  "menu.forgot-password": "Забыль пароль",
  "menu.error": "Ошибка",
  ...
  "menu.form-layouts": "Форма контенты",
  "menu.form-components": "Форма компоненты",
  "menu.form-validations": "Форма валидация",
  "menu.icons": "Иконки",
  "menu.input-groups": "Группа полей",
  "menu.jumbotron": "Заглавный контент",
  "menu.modal": "Модальное окно",
  "menu.navigation": "Навигация",
  "menu.popover-tooltip": "Трещение и подсказки",
  "menu.sortable": "Сортировка",
  "menu.tables": "Таблицы",
  "menu.menu": "Профиль",
  "menu.subhidden": "Суб скрытый",
  "menu.hidden": "Скрытый",
  ...
  "dashboards.yes-it-is-indeed": "Да, это действительно!",
  ...
  "pages.error-title": "Упс, что-то произошло не так по вашему запросу!",
  "pages.error-code": "Ошибка статуса",
  "pages.go-back-home": "Вернуться на главную страницу",
  ...
  "survey.add-new-title": "Добавить новый опрос",
  "survey.title": "Title",
